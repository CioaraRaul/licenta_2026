              ...
              if (c.unreadCount > 0) {
                ...
                if (!existingIds.has(id)) {
                  fresh.push({
                    ...
                    type: "new_message",
                    title: "New message",
                    body: `${c.lastMessage ?? "You have a new message"} — ${c.vehicle.year} ${c.vehicle.make} ${c.vehicle.model}`,
            ...
            for (const bid of received) {
              ...
              if (!existingIds.has(id)) {
                fresh.push({
                  ...
                  body: `${bid.buyer.username} offered $${bid.amount} on ${bid.vehicle.year} ${bid.vehicle.make} ${bid.vehicle.model}`,
              ...
              if (bid.status === "accepted") {
                ...
                if (!existingIds.has(id)) {
                  fresh.push({
                    ...
                    type: "bid_accepted",
                    title: "Bid accepted!",
                    body: `Your offer of $${bid.amount} on ${bid.vehicle.year} ${bid.vehicle.make} ${bid.vehicle.model} was accepted`,
              ...
              if (bid.status === "rejected") {
                ...
                if (!existingIds.has(id)) {
                  fresh.push({
                    ...
                    type: "bid_rejected",
                    title: "Bid rejected",
                    body: `Your offer on ${bid.vehicle.year} ${bid.vehicle.make} ${bid.vehicle.model} was declined`,
                    timestamp: bid.updatedAt,
                    read: false,
                    link: "/bids",
                  });
              ...
              if (bid.status === "withdrawn") {
                ...
                if (!existingIds.has(id)) {
                  fresh.push({
                    ...
                    type: "bid_withdrawn",
                    title: "Bid withdrawn",
                    body: `A bid on ${bid.vehicle.year} ${bid.vehicle.make} ${bid.vehicle.model} was withdrawn`,
                    timestamp: bid.updatedAt,
                    read: false,
                    link: "/bids",
                  });
